...
<section id="features" className="px-4 py-20 bg-background">
  <div className="max-w-7xl mx-auto">
    <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-center">{title}</h2>
  </div>
</section>
```
...
useTypewriter({ ref: animatedTextRef, phrases, theme, enabled: !prefersReducedMotion });
```
